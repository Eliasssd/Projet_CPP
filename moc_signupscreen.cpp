...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SignUpScreen_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SignUpScreen_t qt_meta_stringdata_SignUpScreen = {
    {
QT_MOC_LITERAL(0, 0, 12), // "SignUpScreen"
QT_MOC_LITERAL(1, 13, 11), // "switchToFA2"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12) // "switchToHome"

    },
    "SignUpScreen\0switchToFA2\0\0switchToHome"
};
...
void SignUpScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignUpScreen::switchToFA2)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SignUpScreen::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignUpScreen::switchToHome)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SignUpScreen::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SignUpScreen.data,
...
// SIGNAL 0
void SignUpScreen::switchToFA2()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SignUpScreen::switchToHome()
{
